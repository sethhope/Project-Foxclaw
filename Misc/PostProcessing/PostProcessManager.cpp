...
{	
	...
	loadRTTConfig("Scripts/EffectsConfig/rtt.xml");
	loadEffectConfig("Scripts/EffectsConfig/effect.xml");
...
void CPostProcessManager::SwapAuxBuffers()
{
	...
	video::ITexture* t1 = RenderTargetMap["auxOut"];
	RenderTargetMap["auxIn"]=t1;
